<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminsignup.aspx.cs" Inherits="WebApplication.adminsignup" %>
              ...
              <div class="row">
                 <div class="col">
                    ...
                    <asp:TextBox CssClass="form-control" ID="TBPass" runat="server" placeholder="Password" TextMode="Password"></asp:TextBox>    
                     ...
                     <div class="form-group">
                         <asp:Button runat="server" id="Btnlogin" class="btn btn-success btn-block btn-lg"  type="button" value="button" Text="login" />
                     </div>
